/**
 * DTO de creation d'un vehicule.
 * Tous les champs sont obligatoires sauf statut et paysOrigine.
 */
import {
  IsArray,
  IsEnum,
...
export class CreateVehiculeDto {
  ...
  @ApiProperty({
    example: ['Confort premium', 'Tenue de route', 'Grand coffre'],
  })
  @IsArray()
  @IsString({ each: true })
  pointsForts: string[];
  ...
  @ApiPropertyOptional({
    enum: StatutVehicule,
    example: StatutVehicule.AVAILABLE,
  })
  @IsOptional()
  ...
  @ApiProperty({
    example: 65000,
    description: 'Prix de location par jour (FCFA)',
  })
  @IsInt()
  @Min(0)
  prixLocation: number;
  ...
  @ApiPropertyOptional({
    example: 'DE',
    description: 'Code pays ISO Alpha-2 (utilise pour /vehicules/:id/origine)',
  })
  @IsOptional()
  @IsString()
  paysOrigine?: string;
