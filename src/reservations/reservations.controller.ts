...
export class ReservationsController {
  ...
  @ApiResponse({
    status: 400,
    description:
      'Donnees incoherentes (ex: dates manquantes pour une location)',
  })
  create(
  ...
  @Roles(Role.ADMIN)
  @ApiOperation({
    summary: 'Lister toutes les reservations (admin uniquement)',
  })
  ...
  @Get('me')
  @ApiOperation({
    summary: "Lister les reservations de l'utilisateur connecte",
  })
  @ApiResponse({
    status: 200,
    description: "Reservations de l'utilisateur connecte",
  })
  ...
  @ApiOperation({
    summary:
      "Mettre a jour le statut/paiement d'une reservation (admin uniquement)",
  })
