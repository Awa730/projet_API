...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Le nom complet est obligatoire' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'motdepasse123', minLength: 6 }),
    (0, class_validator_1.MinLength)(6, { message: 'Le mot de passe doit contenir au moins 6 caracteres' }),
    __metadata("design:type", String)
