/**
 * DTO de mise a jour du statut/paiement d'une reservation.
 * Tous les champs sont optionnels ; seul le statut est mis a jour par l'admin.
 */
...
export class UpdateReservationStatutDto {
  @ApiPropertyOptional({
    ...
    example: StatutReservation.CONFIRMEE,
  })
  @IsOptional()
